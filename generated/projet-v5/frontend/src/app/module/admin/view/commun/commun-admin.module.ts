...
import { PurchaseEtatCreateAdminComponent } from './purchase-etat/create/purchase-etat-create-admin.component';
import { PurchaseEtatEditAdminComponent } from './purchase-etat/edit/purchase-etat-edit-admin.component';
import { PurchaseEtatViewAdminComponent } from './purchase-etat/view/purchase-etat-view-admin.component';
...
@NgModule({
  declarations: [
    ...
    PurchaseEtatCreateAdminComponent,
    PurchaseEtatListAdminComponent,
    PurchaseEtatViewAdminComponent,
    PurchaseEtatEditAdminComponent,
