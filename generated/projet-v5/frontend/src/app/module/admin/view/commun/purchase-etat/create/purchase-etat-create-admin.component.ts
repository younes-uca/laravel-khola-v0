...
@Component({
  selector: 'app-purchase-etat-create-admin',
  templateUrl: './purchase-etat-create-admin.component.html'
})
export class PurchaseEtatCreateAdminComponent extends AbstractCreateController<PurchaseEtatDto, PurchaseEtatCriteria, PurchaseEtatAdminService>  implements OnInit {
